...
const Home = () => {
  ...
  return (
    <div>
      ...
      {(rec).length > 0 ? <LatestRecipeContainer heading="Latest Recipes" recipes={rec.slice(-6)} /> : <h1 className='text-2xl font-semibold text-center p-10 animate-ping'>Loading...</h1>}
      </main>
    </div>
  )
}
